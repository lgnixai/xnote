import { FileTypes, IContributeType, IExtension, IMoleculeContext, tree, } from 'aixui';
import { debounce } from 'lodash-es';

import TestPane from '../../components/testPane.tsx';
import { getFileContent, getFiles, getWorkspace, searchFileContents } from '../../api';
import RssPane from "../../components/rss/pane.tsx";
import MainPane from "../../components/rss/main.tsx";
import RssComponent from "~/components/article/rss.component.tsx";

export const NoteExtension: IExtension = {
    id: 'NoteExtension',
    name: 'NoteExtension',
    contributes: {
    ...
    molecule.layout.setPanel(false)
        ...
        molecule.menuBar.onSelect((menuId) => {
            if (menuId === molecule.builtin.getConstants().MENUBAR_ITEM_ABOUT) {
                window.open('https://github.com/lgnixai/xnote', '_blank');
            }
        });
